...
module.exports = function(caller, compilers) {
  ...
  function prepareSource(context, originalSrc, props) {
    ...
    // "Object.defineProperty(module.exports, '_prop_set', { enumerable: false, value: 'function (name, value) {" +
    // " eval('name = ' + (typeof value === 'function') ? value.toString() : JSON.stringify(value));" +
    // " }', writable: true }); " + os.EOL +
    // "Object.defineProperty(module.exports, '_prop_get', { enumerable: false, value: 'function (name) { return eval(name); }', writable: true });";
